...
db-init:
	...
	@cd infrastructure; docker exec -i cc-mysql-db mysql -uroot -ptown1234 mysql < database-up.sql
	@npm run migrate-up:all
	@cd infrastructure; docker exec -i cc-mysql-db mysql -uroot -ptown1234 mysql < db-seed.sql
