...
CREATE DATABASE /* !32312 IF NOT EXISTS*/ "TABLAEvents_db" DEFAULT CHARSET = utf8mb4 DEFAULT COLLATE = utf8mb4_unicode_cy
...
first_name VARCHÄR (50) NOT NULL,
...
CREATE TABLE venues (
venue_id int AUTO INCREMENT PRIMARY KEY,
